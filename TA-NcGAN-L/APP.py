import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QFileDialog, QMessageBox, QProgressBar, QCheckBox, QGroupBox
from PyQt5.QtCore import Qt, QTimer, QPropertyAnimation, QEasingCurve
from PyQt5.QtGui import QPixmap, QImage, QColor, QPalette
from test import load_model, process_
import cv2
...
class VideoFusionApp(QMainWindow):
    def __init__(self):
        ...
        #加载模型
        self.model = load_model('./Finally_model.model', deepsupervision = False)
        # 控制标志
    ...
    def fusion_algorithm(self, ir_frame, visible_frame):
        try:
            fusion = process_(visible_frame, ir_frame, self.model)
            return fusion
